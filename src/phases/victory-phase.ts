...
export class VictoryPhase extends PokemonPhase {
  ...
  start() {
    ...
    if (
      ...
      if ((globalScene.gameMode.isEndless || !globalScene.gameMode.isWaveFinal(globalScene.currentBattle.waveIndex))&&  globalScene.currentBattle.waveIndex<45) {
        ...
        if (globalScene.currentBattle.waveIndex % 15) {
          ...
          if (
            globalScene.currentBattle.waveIndex > 15 &&
          ...
          if (globalScene.gameMode.isEndless && globalScene.currentBattle.waveIndex === 15) {
