...
.setDoubleOnly()
    .initForEliteFour(signatureSpecies["LORELEI"], true,PokemonType.SHIELD, 5)
    .setBattleBgm("zc")
    .setMixedBattleBgm("zc")
.setPartyMemberFunc(0, getRandomPartyMemberFunc([Species.ARK_P67_2]))
.setPartyMemberFunc(1, getRandomPartyMemberFunc([Species.ARK_P56_2]))
    .setPartyMemberFunc(2, getRandomPartyMemberFunc([Species.ARK_P68_2]))
.setPartyMemberFunc(3, getRandomPartyMemberFunc([Species.ARK_P69_2]))
.setPartyMemberFunc(4, getRandomPartyMemberFunc([Species.ARK_P63_2]))
    .setPartyMemberFunc(5, getRandomPartyMemberFunc([Species.ARK_P80_2])),
   
  [TrainerType.BRUNO]: new TrainerConfig(++t)
    .initForEliteFour(signatureSpecies["BRUNO"], true,PokemonType.SWORD, 5)
.setDoubleOnly()
    .setBattleBgm("hange")
    .setMixedBattleBgm("hange")
.setPartyMemberFunc(0, getRandomPartyMemberFunc([Species.ARK_P58_2]))
.setPartyMemberFunc(1, getRandomPartyMemberFunc([Species.ARK_P52_2]))
    .setPartyMemberFunc(2, getRandomPartyMemberFunc([Species.ARK_P57_2]))
.setPartyMemberFunc(3, getRandomPartyMemberFunc([Species.ARK_P54_2]))
.setPartyMemberFunc(4, getRandomPartyMemberFunc([Species.ARK_P53_2]))
    .setPartyMemberFunc(5, getRandomPartyMemberFunc([Species.ARK_P77_2])),


  [TrainerType.AGATHA]: new TrainerConfig(++t)
    .initForEliteFour(signatureSpecies["AGATHA"], false,PokemonType.A_FIRE, 5)
.setDoubleOnly()
    .setBattleBgm("sungan")
    .setMixedBattleBgm("sungan")
.setPartyMemberFunc(0, getRandomPartyMemberFunc([Species.ARK_P60_2]))
.setPartyMemberFunc(1, getRandomPartyMemberFunc([Species.ARK_P70_2]))
    .setPartyMemberFunc(2, getRandomPartyMemberFunc([Species.ARK_P66_2]))
.setPartyMemberFunc(3, getRandomPartyMemberFunc([Species.ARK_P44_2]))
.setPartyMemberFunc(4, getRandomPartyMemberFunc([Species.ARK_P55_2]))
    .setPartyMemberFunc(5, getRandomPartyMemberFunc([Species.ARK_P74_2])),


  [TrainerType.LANCE]: new TrainerConfig(++t)
    .initForEliteFour(signatureSpecies["LANCE"], true,PokemonType.HAMMER, 5)
.setDoubleOnly()
    .setBattleBgm("longge")
    .setMixedBattleBgm("longge")
.setPartyMemberFunc(0, getRandomPartyMemberFunc([Species.ARK_P50_2]))
.setPartyMemberFunc(1, getRandomPartyMemberFunc([Species.ARK_P47_2]))
    .setPartyMemberFunc(2, getRandomPartyMemberFunc([Species.ARK_P51_2]))
.setPartyMemberFunc(3, getRandomPartyMemberFunc([Species.ARK_P48_2]))
.setPartyMemberFunc(4, getRandomPartyMemberFunc([Species.ARK_P46_2]))
    .setPartyMemberFunc(5, getRandomPartyMemberFunc([Species.ARK_P73_2])),
...
.setDoubleOnly()
    .setBattleBgm("battle_wolf_end")
    .setMixedBattleBgm("battle_wolf_end")
.setPartyMemberFunc(0, getRandomPartyMemberFunc([Species.ARK_P81_2]))
.setPartyMemberFunc(1, getRandomPartyMemberFunc([Species.ARK_P72_2]))
    .setPartyMemberFunc(2, getRandomPartyMemberFunc([Species.ARK_P78_2]))
.setPartyMemberFunc(3, getRandomPartyMemberFunc([Species.ARK_P79_2]))
.setPartyMemberFunc(4, getRandomPartyMemberFunc([Species.ARK_P75_2]))
    .setPartyMemberFunc(5, getRandomPartyMemberFunc([Species.ARK_P76_2])),
...
.setDoubleOnly()
    ...
    .setBattleBgm("battle_wolf")
    .setMixedBattleBgm("battle_wolf")
...
,
  [TrainerType.RIVAL_2]: new TrainerConfig(++t)
    ...
    .setMoneyMultiplier(1.25)
    .setEncounterBgm(TrainerType.RIVAL)
    .setBattleBgm("battle_wolf_2")
    .setMixedBattleBgm("battle_wolf_2")
...
Species.ARK_P81,
  ...
  [TrainerType.RIVAL_3]: new TrainerConfig(++t)
    ...
    .setMoneyMultiplier(1.5)
    .setEncounterBgm(TrainerType.RIVAL)
    .setBattleBgm("battle_wolf_3")
    .setMixedBattleBgm("battle_wolf_3")
