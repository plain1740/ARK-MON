...
export const BATTLE_STATS = [ Stat.HP,Stat.ATK, Stat.DEF, Stat.SPATK, Stat.SPDEF, Stat.SPD, Stat.ACC, Stat.EVA] as const;
...
export const TEMP_BATTLE_STATS = [Stat.HP,Stat.ATK, Stat.DEF, Stat.SPATK, Stat.SPDEF, Stat.SPD, Stat.ACC, Stat.HP] as const;
